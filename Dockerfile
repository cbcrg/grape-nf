...
# Install tophat2
RUN  wget -q http://tophat.cbcb.umd.edu/downloads/tophat-2.0.11.Linux_x86_64.tar.gz; \
 tar xf tophat-2.0.11.Linux_x86_64.tar.gz -C /opt; \
 rm -rf tophat-2.0.11.Linux_x86_64.tar.gz; \
 ln -s /opt/tophat-2.0.11.Linux_x86_64 /opt/tophat2
